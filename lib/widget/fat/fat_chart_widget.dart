...
class FatChartWidget extends StatefulWidget {
  const FatChartWidget({super.key});
...
class _FatChartWidgetState extends State<FatChartWidget> {
  ...
  void generateRandomData() {
    ...
    timeDataList = [
      TimeData(domain: DateTime(2024, 2, 3), measure: 20),
      TimeData(domain: DateTime(2024, 2, 10), measure: 20),
      TimeData(domain: DateTime(2024, 2, 17), measure: 21),
      TimeData(domain: DateTime(2024, 2, 24), measure: 21),
      TimeData(domain: DateTime(2024, 3, 2), measure: 21),
      TimeData(domain: DateTime(2024, 3, 9), measure: 22),
      TimeData(domain: DateTime(2024, 3, 16), measure: 22),
