...
class HeightChartWidget extends StatefulWidget {
  const HeightChartWidget({super.key});
...
class _HeightChartWidgetState extends State<HeightChartWidget> {
  ...
  void generateRandomData() {
    ...
    timeDataList = [
      TimeData(domain: DateTime(2024, 2, 3), measure: 170),
      TimeData(domain: DateTime(2024, 2, 10), measure: 170),
      TimeData(domain: DateTime(2024, 2, 17), measure: 170),
      TimeData(domain: DateTime(2024, 2, 24), measure: 170),
      TimeData(domain: DateTime(2024, 3, 2), measure: 170),
      TimeData(domain: DateTime(2024, 3, 9), measure: 170),
      TimeData(domain: DateTime(2024, 3, 16), measure: 170),
